# Technology Centres and Innovation Ecosystem Overview at MSAJCE
...
- **Centre for Industrial Robotics**.

- **Centre for NDT – Non Destructive Testing**.

- **Centre for Building Information Modelling**.

#### ECE & EEE Technology Centres

- **Centre for Embedded & IoT**.

- **Centre for UAV/Drone Technology**.

- **Godrej Disha Skill Development Centre**.

- **Centre for Bosch Industry Institute Collaboration**.

- **Centre for E-Mobility**.

- **Centre for Renewable Energy**.

- **APJ Abdul Kalam Innovation Centre**.

#### CSE & IT Technology Centres

- **Centre for Bot Lab & Robotics Process Automation**.

- **Centre for Cisco Networking Academy**.

- **Centre for Code Tantra – Coding Learning Centre**.

- **Centre for Gaming and AR/VR**.

- **Centre for Artificial Intelligence and Machine Learning**.

- **Centre for Block Chain Technology**.

- **Centre for Mobile and Web Application Development**.
...
## **3. CISCO Networking Academy Centre — Objectives, Outcomes and Certifications**
...
## **4. CISCO CCNAv7 — Introduction to Networks (Full Syllabus)**
...
- **Networking Today** serves as **Networking Today**.

- **Basic Switch and End Device Configuration: Cisco IOS Access – IOS Navigation – Command Structure – Basic Device Configuration** serves as **Basic Switch and End Device Configuration: Cisco IOS Access – IOS Navigation – Command Structure – Basic Device Configuration**.

- **Protocol and Models: The Rules – Protocol Suites – Standards Organizations – Reference Models – Data Encapsulation – Data Flow** serves as **Protocol and Models: The Rules – Protocol Suites – Standards Organizations – Reference Models – Data Encapsulation – Data Flow**.

- **Physical Layer: Purpose – Physical Layer Characteristics – Copper Cabling – UTP Cabling – Fiber-Optic Cabling – Wireless** serves as **Physical Layer: Purpose – Physical Layer Characteristics – Copper Cabling – UTP Cabling – Fiber-Optic Cabling – Wireless**.

- **Number Systems: Binary Number System – Hexadecimal Number System** serves as **Number Systems: Binary Number System – Hexadecimal Number System**.

- **Data Link Layer: Purpose – Topologies – Data Link Frame** serves as **Data Link Layer: Purpose – Topologies – Data Link Frame**.

- **Ethernet Switching: Ethernet Frame – Ethernet MAC Address – The MAC Address Table – Switch Speeds and Forwarding Modes** serves as **Ethernet Switching: Ethernet Frame – Ethernet MAC Address – The MAC Address Table – Switch Speeds and Forwarding Modes**.

- **Network Layer: Network Layer Characteristics – IPv4 and IPv6 Packet – Router Routing Table** serves as **Network Layer: Network Layer Characteristics – IPv4 and IPv6 Packet – Router Routing Table**.

- **Address Resolution: MAC and IP – ARP – Neighbor Discovery** serves as **Address Resolution: MAC and IP – ARP – Neighbor Discovery**.

- **Basic Router Configuration: Configure Initial Router Settings – Configure Interfaces – Configure the Default Gateway** serves as **Basic Router Configuration: Configure Initial Router Settings – Configure Interfaces – Configure the Default Gateway**.

- **IPv4 Addressing: IPv4 Address Structure – Unicast/Broadcast/Multicast – Types of IPv4 Addresses – Network Segmentation** serves as **IPv4 Addressing: IPv4 Address Structure – Unicast/Broadcast/Multicast – Types of IPv4 Addresses – Network Segmentation**.

- **IPv6 Addressing: IPv6 Addressing – Address Types – GUA and LLA Static Configuration – Dynamic Addressing – IPv6 Multicast** serves as **IPv6 Addressing: IPv6 Addressing – Address Types – GUA and LLA Static Configuration – Dynamic Addressing – IPv6 Multicast**.

- **ICMP: ICMP Messages – Ping and Traceroute Testing** serves as **ICMP: ICMP Messages – Ping and Traceroute Testing**.

- **Transport Layer: Transportation of Data – TCP Overview – UDP Overview – Port Numbers – TCP Communication Process** serves as **Transport Layer: Transportation of Data – TCP Overview – UDP Overview – Port Numbers – TCP Communication Process**.

- **Application Layer: Application, Presentation, and Session – Peer-to-Peer – Web and Email Protocols – IP Addressing Services** serves as **Application Layer: Application, Presentation, and Session – Peer-to-Peer – Web and Email Protocols – IP Addressing Services**.

- **Network Security Fundamentals: Security Threats and Vulnerabilities – Network Attacks – Attack Mitigation – Device Security** serves as **Network Security Fundamentals: Security Threats and Vulnerabilities – Network Attacks – Attack Mitigation – Device Security**.

- **Build a Small Network: Devices – Small Network Applications and Protocols – Scale to Larger Networks – Verify Connectivity** serves as **Build a Small Network: Devices – Small Network Applications and Protocols – Scale to Larger Networks – Verify Connectivity**.
...
## **6. Amazon Web Services (AWS) & Cloud Computing Centre**

### **Amazon Web Services (AWS) & Cloud Computing Centre**

Industry Partner: Amazon Web Services (AWS)

This centre is part of MSJCE's broader Technology Centre ecosystem established in 2019-2020 under AICTE and India Skill Report 2020 recommendations.
...
## **7. Cyber Security Academy — Palo Alto Systems**
...
Abroad Studies | Abroad Traineeships | Abroad Internships | Abroad Placements | Abroad Mentorships | Abroad Fellowships | Abroad Inventorships | Startup Founderships | Disruptive Technologies | Product Development | CSR Activities
...
- **msajce.office@gmail.com**, Contact Email: `msajce.office@gmail.com`.

- **grievance@msajce-edu.in**, Contact Email: `grievance@msajce-edu.in`.
...
- **Under the aegis of Mohamed Sathak Trust   Government of Tamil Nadu approved**.
