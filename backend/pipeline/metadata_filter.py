...
class MetadataFilter:
    ...
    def build_filter(self, category: str | None, entity_id: str | None = None, source_file: str | None = None):
        """
        ...
        Args:
            ...
            source_file: exact source file basename (e.g. 'msajce_transport.md') to filter on, or None

        Returns:
            qdrant_client.models.Filter if filters provided, else None
        """
        if not category and not entity_id and not source_file:
            return None
